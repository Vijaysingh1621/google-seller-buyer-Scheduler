      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white p-8 rounded-xl shadow-lg text-center">
            ...
            <h3 className="text-xl font-semibold mb-2">Google Calendar Integration</h3>
            <p className="text-gray-600">
              Seamlessly sync appointments with your Google Calendar. No double booking.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg text-center">
            ...
            <p className="text-gray-600">
              See available time slots in real-time based on calendar availability.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg text-center">
            ...
            <p className="text-gray-600">
              Appointments are created on both participant's calendars automatically.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white p-8 rounded-xl shadow-lg">
            <h3 className="text-2xl font-semibold mb-4 text-blue-600">For Sellers</h3>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            <h3 className="text-2xl font-semibold mb-4 text-green-600">For Buyers</h3>
            <ul className="space-y-3 text-gray-600">
              <li className="flex items-center">
